        ...
        return (
            <Container fluid={true}>
                <Row>
                    ...
                    <Col>{this.state.selecteditemid ? <Template selectedTemplateID={this.state.selecteditemid} onTemplateUpdated={this.handleItemUpdated} /> : <NoItemSelected itemName="Template" />}</Col>
